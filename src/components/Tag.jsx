...
const Tag = () => {
  ...
  return (
    <div className="flex flex-col items-center w-1/2 m-auto mt-10 bg-yellow-400 border border-black rounded-xl">
      <h1 className="text-lg font-bold underline uppercase mb-1 mt-1">
        Random {tag} Gif
      </h1>
      {loading ? <Spinner /> : <img src={gif} alt="gif" width={340} />}

      <input
        className="w-10/12 font-bold border rounded-lg  bg-white rounder-sm mt-1 mb-1 text-center"
